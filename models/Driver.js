...
DriverSchema.index({ registrationStatus: 1, createdAt: -1 });
DriverSchema.index({ city: 1, isActive: 1 });
DriverSchema.index({ workArea: 1, isActive: 1 });
DriverSchema.index({ phone: 1 });
DriverSchema.index({ idNumber: 1 });

// Compound index for active + not blocked + rating (leaderboard)
DriverSchema.index({ 
  isActive: 1, 
  isBlocked: 1, 
  'rating.average': -1 
 ...
 */
DriverSchema.statics.getPendingRegistrations = function() {
  return this.find({ 
